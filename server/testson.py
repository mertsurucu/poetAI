...
def load_model(text_path, network_path, trigram_path):
...
def load_models():
    ...
    with graph.as_default():
        ...
        cat1_model = load_model(text1, category_1_model_path, cat1_trigram_path)
        cat2_model = load_model(text2, category_2_model_path, cat2_trigram_path)
        cat3_model = load_model(text3, category_3_model_path, cat3_trigram_path)
...
def get():
    ...
    model_idx = 3
    poem = generate_poem(diversity=0.5, range_=1000, n_line=12, model=models[model_idx])
    print(poem)
...
# s = time.time()
#
# poem = generate_poem(diversity=0.5, range_=1000, n_line=12)
#
# print(time.time()-s)
#
# # lm.generate_txt(10)
